<template><h1 id="proposta-commerciale" tabindex="-1"><a class="header-anchor" href="#proposta-commerciale" aria-hidden="true">#</a> Proposta Commerciale</h1>
...
<p>Spett.le {{ $frontmatter.client }},</p>
<p>Grazie per averci contattato.
Qui ti presentiamo una stima preliminare per la manutenzione del sito <strong>{{ $frontmatter.projectname }}</strong>.</p>
<p>In base alle informazioni che ci hai fornito il tuo progetto richiede un investimento di
<span title="minimum" class="Label bg-green">{{ $frontmatter.minprice }}</span> mensili, per un totale di <span title="maximum" class="Label bg-red">{{ $frontmatter.maxprice }}</span> annui.</p>
<h2 id="backup" tabindex="-1"><a class="header-anchor" href="#backup" aria-hidden="true">#</a> Backup</h2>
<p>I Backup sono una parte fondamentale della gestione di un sito web. Se un aggiormanento fallisce, o il sito &quot;cade&quot; è imperativo avere un backup aggiornato del sito web. HRSlab provvede ad eseguire backup incrementali a cadenza regolare, assicurando che un backup aggiornato sia sempre disponibile.</p>
<p>I nostri backup incrementali possono includere servizi di off-site storage e possono essere eseguiti con cadenza settimaname, giornaliera ed oraria.</p>
<p>I server di conservazione dei dati sono scelti tra Stati Uniti e Europa in base alle attuali regolamentazioni GDPR.</p>
<p>Il servizio di Backup comprende i seguenti servizi:</p>
<ul>
<li>[X] Backup Mensile.</li>
<li>[X] Conservazione dei dati off-line.</li>
<li>[X] Rispristino Veloce.</li>
<li>[X] Scelta di archiviazione in server US/EU.</li>
<li>[X] exclusione/inclusione di files e folders.</li>
<li>[X] Notifiche in caso di interruzione di servizio/rete.</li>
<li>[X] Backups su richiesta.</li>
<li>[X] Clonazione/migrazione.</li>
<li>[X] Scelta di frequenza di backup, da settimanale a quasi real-time (ogni 1h)</li>
<li>[X] Invio dei backup in cartelle compresse.</li>
</ul>
<div class="custom-container tip"><p class="custom-container-title">NOTE</p>
<p>La tua offerta non copre i backups in tempo reale e quelli giornalieri, ma include backup settimanali.</p>
</div>
<p>I backups sono conservati per 90 giorni. In caso di cancellazione del contratto, i backups verranno cancellati dopo 7 giorni. Se hai la necessità di archiviare i tuoi backups per più di 90 giorni contattaci.</p>
...
<h2 id="monitoraggio-della-sicurezza" tabindex="-1"><a class="header-anchor" href="#monitoraggio-della-sicurezza" aria-hidden="true">#</a> Monitoraggio della sicurezza</h2>
<p>Questo monitoraggio ti permette avere la certezza che il tuo sito è privo di malware e virus. Se un file viene infetto verrà individuato e notificato.</p>
<p>I monitoraggi di sicurezza vengono eseguiti 24 ore al giorno e 7 giorni su sette individuando malware e se il tuo sito compare in qualche blacklist.</p>
<p>Non Appena un problema è individuato verrai informato via email o slack.</p>
<div class="Box border-0">
  <div class="Box-body border-0">
    <ul>
    <li class="Box-row border">
...
<h2 id="monitoraggio-uptime" tabindex="-1"><a class="header-anchor" href="#monitoraggio-uptime" aria-hidden="true">#</a> Monitoraggio Uptime</h2>
<p>Il Monitoraggio Uptime permette di sapere se un sito è online e notifica instantamente quando un sito va offline. Dando l'opportunità di intervenire tempestivamente. Quando il tuo sito è offline si perdono visitatori e fatturato. Il Monitoraggio Uptime assicura che qeusto non accada al tuo sito.</p>
<div class="Box border-0">
  <div class="Box-body border-0">
    <ul>
    <li class="Box-row border">
...
<h2 id="gestione-dei-temi-e-plugins" tabindex="-1"><a class="header-anchor" href="#gestione-dei-temi-e-plugins" aria-hidden="true">#</a> Gestione dei Temi e Plugins</h2>
<p>Gestire temi e plugins è la parte che richiede più tempo nella manutenzione di un sito web.
esaminare ogni plugins per verificare quali vanno aggiornati e quali vanno installati può richiedere diverse ore. Ci occuperemo di gestire per te plugins e temi per tenerli sempre aggiornati. Tutti gli aggiornamenti saranno eseguiti in momento di basso traffico per il tuo sito.</p>
<p>Potrai vedere tutti gli aggiornamenti eseguiti nel report settimanale.</p>
<h2 id="monitoraggio-delle-prestazioni" tabindex="-1"><a class="header-anchor" href="#monitoraggio-delle-prestazioni" aria-hidden="true">#</a> Monitoraggio delle Prestazioni</h2>
<p>Un sito lento può danneggiare notevolmente il tuo business. Questa è la ragione per controllare le prestazioni del tuo sito con regolarità e prendere provvedimenti se qualcosa non funziona.</p>
<p>Questo monitoraggio ti da una panoramica di quello che succede al tuo sito web e quali sono le sue prestazioni. E' il primo passo per risolvere eventuali problemi, evidenziando i fattori che
che influenzano le prestazioni il tuo sito. Potrai vedere ogni singolo problema con l'indice di gravità e le raccomandazioni per risolverlo.</p>
<p>Il Monitoraggio delle prestazioni viene eseguito una volta alla settimana. Verrai notificato via email o Slack. Provvederemo anche a risolvere eventuali problemi di prestazioni che sono sotto il nostro controllo.</p>
<p>Nel report settimanale potrai vedere una dettagliata lista dei risulati e le azioni da intraprendere per migliorare le prestazioni del tuo sito.</p>
<div class="Box border-0">
  <div class="Box-body border-0">
    <ul>
    <li class="Box-row border">
...
<h2 id="commenti-espam" tabindex="-1"><a class="header-anchor" href="#commenti-espam" aria-hidden="true">#</a> Commenti eSpam</h2>
<p>A volte anche i migliori filri si fanno sfuggire i messaggi spam. Avere una lista completa di tutti i tuoi commenti è una best practice per tenere a bada messaggi indesiderati.</p>
<p>Ci occuppiamo di pulire tutti i tuoi messaggi spam e lasciare gli altri a te.</p>
<h2 id="analytics" tabindex="-1"><a class="header-anchor" href="#analytics" aria-hidden="true">#</a> Analytics</h2>
<p>Integrazione con Google Analytics.
Vedrai i dati di Google Analytics direttamente nel tuo report di manutenzione.
A colpo d'occhio protrai tenere traccia di tutti i risultati, scoprire cosa funziona e cosa no.</p>
<p>Maggiori info: <a href="https://analytics.google.com" target="_blank" rel="noopener noreferrer">https://analytics.google.com<ExternalLinkIcon/></a></p>
<h2 id="monitoraggio-parole-chiave" tabindex="-1"><a class="header-anchor" href="#monitoraggio-parole-chiave" aria-hidden="true">#</a> Monitoraggio Parole Chiave</h2>
<p>Non devi più trovare, controllare e registrare separatamente le tue keywords.
Il Monitoraggio delle Parole Chiave organizza tutte le metriche fondamentali in unico posto.
Indica i principali competitors e una timeline delle classifica della tua poszione.</p>
<div class="Box border-0">
  <div class="Box-body border-0">
    <ul>
    <li class="Box-row border">
...
<h2 id="modifiche-illimitate" tabindex="-1"><a class="header-anchor" href="#modifiche-illimitate" aria-hidden="true">#</a> Modifiche Illimitate</h2>
...
<p>Le Modifiche Illimitate non includono lo sviluppo personalizzato (PHP, plugins, temi, ecc..), aggiornamento di codice personalizzato, grafica, conversione di Grafica a WordPress, creazione dei contenuti, sviluppare un nuovo sito, operazioni server.</p>
</p>
