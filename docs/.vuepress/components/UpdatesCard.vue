<template>
  <div
    ...
    class="Box py-3 color-bg-subtle color-shadow-medium my-2"
  >
    <div class="Subhead p-2">
      ...
      <p
        class="Subhead-description text-small tooltipped tooltipped-w"
        aria-label="Procedura di aggiornamento atta ad evitare conflitti e downtime"
      >
        Safe Updates: <span class="color-fg-success"> Active</span>
      </p>
    </div>
    <section id="updates">
      <slot></slot>
